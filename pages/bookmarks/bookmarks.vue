		...
		methods: {
			loadBookmarks: function() {
				...
				util.request(config.api.bookmark, {
					...
					that.tips = bookmarks.length > 0 ? '' : ' -- 您暂时还有没有书签 -- '
					uni.hideLoading()
				})
			},
...
<style>
.col-11 navigator{color: #353535;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;}
.col-11 text{display: inline-block;margin-right: 15upx;}
.row{border-bottom: 1upx solid #efefef;line-height: 300%;}
</style>
